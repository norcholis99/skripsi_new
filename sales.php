  ...
  <div class="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <div class="row">
         ...
         <div class="header">
			...
			<h4> &nbsp Data Kunjungan Harian<br> &nbsp PT. Megah Medika Pharma Cabang Banjarmasin</h4>
		</div>

		<div class="button" style="margin: 5px" data-target="#mdl" data-toggle="modal">Tambah Data

		<form method="GET" action="sales.php" style="float: left;"></div>
	...
	<div class="modal" tabindex="-1" role="dialog" id="mdl">
    	...
    	<div class="modal-content">
      	<div class="modal-header">
        	<h5 class="modal-title">Input Data Laporan Kunjungan</h5>
      	...
      	<div class="modal-body">
			<form method="POST" action="sales_tambah.php">
      			<div class="container">
          ...
          <div class="form-group row mt-3" hidden="">
            ...
            <div class="col-sm-8"><input type="text" name="no7" class="form-control"></div>
          </div>
    ...
    <table class="table table-bordered">
      ...
      <th style="text-align: center;">Tanggal</th>
			...
			<th style="text-align: center;">Hsil</th>
