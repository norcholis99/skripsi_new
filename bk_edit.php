...
if ($_POST['getId']) {
	# code...
	$no=$_POST['getId'];
	$sql=mysqli_query($kon, "select * from barang_keluar where no_faktur='$no'");	
	while ($aa=mysqli_fetch_array($sql)) {
		# code...
		?>	

			<form action="bk_edit_aksi.php" method="post">
				<div class="container">
      		...
      		<div class="form-group row mt-3">
                  ...
                  <div class="form-group row mt-3">
                        ...
                        <div class="col-sm-8"><input type="text" name="id6" class="form-control" required="" value="<?php echo $aa['kode_barang'] ?>"></div>
                  </div>

                  <div class="form-group row mt-3">
                        <label class="col-sm-4 col-sm-label">Nama Barang</label>
                        <div class="col-sm-8"><input type="text" name="id7" class="form-control" required="" value="<?php echo $aa['nama_barang'] ?>"></div>
                  </div>

                  <div class="form-group row mt-3">
                        <label class="col-sm-4 col-sm-label">Quantity</label>
                        <div class="col-sm-8"><input type="text" name="id8" class="form-control" required="" value="<?php echo $aa['quantity'] ?>"></div>
                  </div>

      		<div class="form-group row mt-3">
      			<label class="col-sm-4 col-sm-label">Satuan</label>
      			<div class="col-sm-8"><input type="text" name="id9" class="form-control" required="" value="<?php echo $aa['satuan'] ?>"></div>
      		</div>

                  <div class="form-group row mt-3">
                        <label class="col-sm-4 col-sm-label">Harga</label>
                        <div class="col-sm-8"><input type="text" name="id10" class="form-control" required="" value="<?php echo $aa['harga'] ?>"></div>
                  </div>

                  <div class="form-group row mt-3">
                        <label class="col-sm-4 col-sm-label">Total Sementara</label>
                        <div class="col-sm-8"><input type="text" name="id11" class="form-control" required="" value="<?php echo $aa['total_1'] ?>"></div>
                  </div>

      		<div class="form-group row mt-3">
      			<label class="col-sm-4 col-sm-label">Ppn</label>
      			<div class="col-sm-8"><input type="text" name="id12" class="form-control" required="" value="<?php echo $aa['ppn'] ?>"></div>
      		</div>

                  <div class="form-group row mt-3">
                        <label class="col-sm-4 col-sm-label">Ongkir</label>
                        <div class="col-sm-8"><input type="text" name="id13" class="form-control" required="" value="<?php echo $aa['ongkir'] ?>"></div>
                  </div>

                  <div class="form-group row mt-3">
                        <label class="col-sm-4 col-sm-label">Total Bayar</label>
                        <div class="col-sm-8"><input type="text" name="id14" class="form-control" required="" value="<?php echo $aa['total_bayar'] ?>"></div>
                  </div>
