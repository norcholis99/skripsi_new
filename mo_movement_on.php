  ...
  <div class="content-wrapper">
    <section class="content">
      <div class="header">
			...
			<h4> &nbsp Movement On (Permintaan Barang)<br> &nbsp PT. Megah Medika Pharma Cabang Banjarmasin</h4>
		</div>

		<div class="button" style="margin: 5px" data-target="#mdl" data-toggle="modal">Tambah Data

		<form method="GET" action="mo_movement_on.php" style="float: left;"></div>
    ...
    <div class="modal" tabindex="-1" role="dialog" id="md5">
      ...
      <form method="GET" action="mo_report.php">
            <div class="container">
	...
	<div class="modal" tabindex="-1" role="dialog" id="mdl">
    	...
    	<div class="modal-content">
      	<div class="modal-header">
        	<h5 class="modal-title">Input Data Permintaan Barang</h5>
        		<button type="button" class="close" data-dismiss="modal" aria-label="Close">
          			<span aria-hidden="true">&times;</span>
        		</button>
      	</div>
      	...
      	<div class="modal-body">
			<form method="POST" action="mo_tambah.php">
      			<div class="container">
          ...
          <div class="form-group row mt-3">
            <label class="col-sm-4 col-sm-label">No MO</label>
    ...
    <table class="table table-bordered">
      ...
      <th style="text-align: center;">No</th>
			<th style="text-align: center;">No MO</th>
	...
	<tbody>
		<?php 
			...
			$sql=mysqli_query($kon,"select * from movement_on where no_mo like '%".$cari."%' or kode_barang like '%".$cari."%' or nama_barang like '%".$cari."%' order by no asc ");
		} else {$sql = mysqli_query($kon,"select * from movement_on order by no asc");
			}
        ...
        <td style="text-align: center;"><?php echo $saa['no']; ?></td>
				...
				<td><?php echo $saa['keterangan']; ?></td>

				<td style="text-align: center;">
							
					<a class="edit.record" href="#" data-target="#md2" data-toggle="modal" data-id=<?php echo $saa ['no_mo'] ; ?>>
            <i class="nav-icon fas fa-key text-info"></i>
          </a>&nbsp&nbsp
					
					<a href="mo_hapus.php?id=<?php echo $saa ['no_mo'];?>">
		...
		<tr>
			...
			<div class="modal fade" tabindex="-1" role="dialog" id="md2">
  				<div class="modal-dialog" role="document">
    				<div class="modal-content">
      					<div class="modal-header">
        					<h5 class="modal-title">Edit Data Permintaan Barang</h5>
        					<button type="button" class="close" data-dismiss="modal" aria-label="Close">
          						<span aria-hidden="true">&times;</span>
        					</button>
      					</div>
