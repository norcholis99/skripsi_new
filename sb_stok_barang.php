  ...
  <div class="content-wrapper">
    <section class="content">
      <div class="container-fluid">
		...
		<form method="GET" action="sb_stok_barang.php" style="float: left;"></div>
	...
	<tbody>
      ...
      $saa = $sql->fetch_assoc();
        ...
        echo "<script> alert ('hai admin, stock menipis di barang ".$saa['nama_barang'].", cepat tambah stocknya !') </script>";
			  ...
			  $sql=mysqli_query($kon,"select * from stok_barang where kode_barang like '%".$cari."%' or nama_barang like '%".$cari."%' order by no asc ");
		    } else {$sql = mysqli_query($kon,"select * from stok_barang order by no asc");
			     }
        ...
        <td style="text-align: center;"><?php echo $saa['no']; ?></td>
				...
				<td style="text-align: center;"><?php echo $saa['tgl_expired']; ?></td>

				<td style="text-align: center;">
							
					<a class="edit.record" href="#" data-target="#md2" data-toggle="modal" data-id=<?php echo $saa ['kode_barang'] ; ?>>
            <i class="nav-icon fas fa-key text-info"></i>
          </a>&nbsp&nbsp
					
					<a href="sb_hapus.php?id=<?php echo $saa ['kode_barang'];?>">
