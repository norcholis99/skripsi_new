...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
     <div class="header">
      ...
      <form method="GET" action="pt2.php" style="float: left;">
  ...
  <tbody>
    ...
    <?php 
      ...
      $sql=mysqli_query($kon,"select * from piutang2 where no_faktur like '%".$cari."%' or nama_pelanggan like '%".$cari."%' order by no_faktur desc ");
    } else {$sql = mysqli_query($kon,"select * from piutang2 order by no_faktur desc");
      }
