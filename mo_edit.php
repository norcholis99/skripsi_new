...
if ($_POST['getId']) {
	# code...
	$no=$_POST['getId'];
	$sql=mysqli_query($kon, "select * from movement_on where no_mo='$no'");	
	while ($aa=mysqli_fetch_array($sql)) {
		# code...
		?>	

	<form action="mo_edit_aksi.php" method="post">
		<div class="container">
          ...
          <div class="form-group row mt-3" hidden="">
            ...
            <div class="col-sm-8"><input type="text" name="id1" class="form-control" required="" value="<?php echo $aa['no_mo'] ?>"></div>
          </div>	
