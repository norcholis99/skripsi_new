...
<div class="wrapper">
  ...
  <div class="content-wrapper">
        ...
        <div class="row">
          <section class="col-lg-12 connectedSortable">
           <div class="header">
			...
			<h4> &nbsp Data Barang Masuk<br> &nbsp PT. Megah Medika Pharma Cabang Banjarmasin</h4>
		</div>

		<div class="button" style="margin: 5px" data-target="#mdl" data-toggle="modal">Tambah Data

		<form method="GET" action="bm_barang_masuk.php" style="float: left;"></div>
    ...
    <div class="modal" tabindex="-1" role="dialog" id="md5">
      ...
      <form method="GET" action="bm_report.php">
            <div class="container">
	...
	<div class="modal" tabindex="-1" role="dialog" id="mdl">
    	...
    	<div class="modal-content">
      	...
      	<div class="modal-body">
			<form method="POST" action="bm_tambah.php">
      			<div class="container">
	...
	<tbody>
		<?php 
			...
			$sql=mysqli_query($kon,"select * from barang_masuk where no_register like '%".$cari."%' or tanggal like '%".$cari."%' or kode_barang like '%".$cari."%' or nama_barang like '%".$cari."%' order by no_register desc ");
		} else {$sql = mysqli_query($kon,"select * from barang_masuk order by no_register desc");
			}
			...
			<tr>
				<td><?php echo $saa['no_register']; ?></td>
				<td style="text-align: center;"><?php echo $saa['tanggal']; ?></td>
				<td><?php echo $saa['kode_barang']; ?></td>
				...
				<td style="text-align: center;">
					...
					<a class="edit.record" href="#" data-target="#md2" data-toggle="modal" data-id=<?php echo $saa ['no_register'] ; ?>>
            <i class="nav-icon fas fa-key text-info"></i>
          </a>&nbsp&nbsp
					
					<a href="bm_hapus.php?id=<?php echo $saa ['no_register'];?>">
...
<script>
  ...
  $("#no_register").keyup(function(event){
    if (event.which == 13 || event.keycode == 13){
      $("#tanggal").focus();
    }
  });
