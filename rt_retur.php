  ...
  <div class="content-wrapper">
    <section class="content">
      <div class="header">
			...
			<h4> &nbsp Data Retur<br> &nbsp PT. Megah Medika Pharma Cabang Banjarmasin</h4>
		</div>

		<div class="button" style="margin: 5px" data-target="#mdl" data-toggle="modal">Tambah Data

		<form method="GET" action="rt_retur.php" style="float: left;"></div>
	...
	<div class="modal" tabindex="-1" role="dialog" id="mdl">
    	...
    	<div class="modal-content">
      	<div class="modal-header">
        	<h5 class="modal-title">Input Data Retur</h5>
      	...
      	<div class="modal-body">
			<form method="POST" action="rt_tambah.php">
      			<div class="container">
            ...
            <div class="form-group row mt-3">
                ...
                <div class="col-sm-8"><input type="text" name="no7" class="form-control" id="quantity" onkeyup="sum();" required=""></div>
            </div>

      		<div class="form-group row mt-3">
      			<label class="col-sm-4 col-sm-label">Satuan</label>
      			<div class="col-sm-8"><select type="text" name="no8" class="form-control" value="option">
            ...
            <div class="form-group row mt-3">
                ...
                <div class="col-sm-8"><input type="text" name="no9" class="form-control" id="harga" onkeyup="sum();" required=""></div>
            </div>

            <div class="form-group row mt-3">
                <label class="col-sm-4 col-sm-label">Total Sementara</label>
                <div class="col-sm-8"><input type="text" name="no10" class="form-control" id="total_1" onkeyup="sum();" required=""></div>
            </div>

      		<div class="form-group row mt-3">
      			<label class="col-sm-4 col-sm-label">Ppn</label>
      			<div class="col-sm-8"><input type="text" name="no11" class="form-control" id="ppn" onkeyup="sum();" required=""></div>
      		</div>
	...
	<tbody>
		<?php 
			...
			$sql=mysqli_query($kon,"select * from retur where no_retur like '%".$cari."%' or nama_pelanggan like '%".$cari."%' or kode_barang like '%".$cari."%' or nama_barang like '%".$cari."%' order by no_retur asc ");
		} else {$sql = mysqli_query($kon,"select * from retur order by no_retur asc");
			}
			while ($saa=mysqli_fetch_array($sql)) {
				# code...
			 ?>
			<tr>
				<td><?php echo $saa['no_retur']; ?></td>
				...
				<td style="text-align: center;">
					...
					<a class="edit.record" href="#" data-target="#md2" data-toggle="modal" data-id=<?php echo $saa ['no_retur'] ; ?>>
            <i class="nav-icon fas fa-key text-info"></i>
          </a>&nbsp&nbsp
					
					<a href="rt_hapus.php?id=<?php echo $saa ['no_retur'];?>">
		...
		<tr>
			...
			<div class="modal fade" tabindex="-1" role="dialog" id="md2">
  				<div class="modal-dialog" role="document">
    				<div class="modal-content">
      					<div class="modal-header">
        					<h5 class="modal-title">Edit Data Retur</h5>
        					<button type="button" class="close" data-dismiss="modal" aria-label="Close">
          						<span aria-hidden="true">&times;</span>
        					</button>
      					</div>
