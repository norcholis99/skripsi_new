...
if ($_POST['getId']) {
	# code...
	$no=$_POST['getId'];
	$sql=mysqli_query($kon, "select * from stok_barang where kode_barang='$no'");	
          ...
          <div class="form-group row mt-3">
            ...
            <div class="col-sm-8"><input type="text" name="id3" class="form-control" required="" value="<?php echo $aa['satuan'] ?>"></div>
      		...
      		<div class="form-group row mt-3">
      			...
      			<div class="col-sm-8"><input type="date" name="id5" class="form-control" required="" value="<?php echo $aa['tgl_expired'] ?>"></div>
      		</div>
