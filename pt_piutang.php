  ...
  <div class="content-wrapper">
    <section class="content">
      <div class="header">
			...
			<h4> &nbsp Data Piutang<br> &nbsp PT. Megah Medika Pharma Cabang Banjarmasin</h4>
		</div>

		<!-- <div class="button" style="margin: 5px" data-target="#mdl" data-toggle="modal">Tambah Data -->

		<form method="GET" action="pt_piutang.php" style="float: left;"><!-- </div> -->
    ...
    <div class="modal" tabindex="-1" role="dialog" id="md5">
      ...
      <form method="GET" action="pt_report.php">
            <div class="container">
	...
	<div class="modal" tabindex="-1" role="dialog" id="mdl">
    	...
    	<div class="modal-content">
      	<div class="modal-header">
        	<h5 class="modal-title">Input Data Piutang</h5>
        		<button type="button" class="close" data-dismiss="modal" aria-label="Close">
          			<span aria-hidden="true">&times;</span>
        		</button>
      	</div>
      	...
      	<div class="modal-body">
			<form method="POST" action="pt_tambah.php">
      			<div class="container">
    ...
    //   $sql=mysqli_query($kon,"select * from piutang where no_faktur like '%".$cari."%' or nama_pelanggan like '%".$cari."%' order by no_faktur desc");
    // } else {$sql = mysqli_query($kon,"select * from piutang order by no_faktur desc");
    //   } 

 $sql = mysqli_query($kon,"SELECT *,DATE_ADD(tgl_faktur, INTERVAL 30 DAY) as tgl_jatuhtempo, DATEDIFF(DATE_ADD(tgl_faktur, INTERVAL 30 DAY), CURDATE()) as hariberjalan FROM piutang");
        ...
        <td style="text-align: center;"><?php echo $saa['tgl_jatuhtempo']; ?></td>
				<td style="text-align: center;"><?php echo $saa['hariberjalan'].' hari'; ?></td>
    ...
    ?>
     ...
     <th colspan="6" style="text-align: center; font-size: 12px">Total</th>
