  ...
  <div class="content-wrapper">
    <section class="content">
      <div class="header">
			...
			<h4> &nbsp Pembelian Lokal<br> &nbsp PT. Megah Medika Pharma Cabang Banjarmasin</h4>
		</div>

		<div class="button" style="margin: 5px" data-target="#mdl" data-toggle="modal">Tambah Data

		<form method="GET" action="pl_pembelian_lokal.php" style="float: left;"></div>
    ...
    <div class="modal" tabindex="-1" role="dialog" id="md5">
      ...
      <form method="GET" action="pl_report.php">
            <div class="container">
	...
	<div class="modal" tabindex="-1" role="dialog" id="mdl">
    	...
    	<div class="modal-content">
      	<div class="modal-header">
        	<h5 class="modal-title">Input Data Pembelian Lokal</h5>
        		<button type="button" class="close" data-dismiss="modal" aria-label="Close">
          			<span aria-hidden="true">&times;</span>
        		</button>
      	</div>
      	...
      	<div class="modal-body">
			<form method="POST" action="pl_tambah.php">
      			<div class="container">
          ...
          <div class="form-group row mt-3">
            <label class="col-sm-4 col-sm-label">No PL</label>
            <div class="col-sm-8"><input type="text" name="no1" class="form-control" required=""></div>
      		...
      		<div class="form-group row mt-3">
      			<label class="col-sm-4 col-sm-label">Penyedia</label>
	...
	<tbody>
		<?php 
			...
			$sql=mysqli_query($kon,"select * from pembelian_lokal where no_pl like '%".$cari."%' or kode_barang like '%".$cari."%' or nama_barang like '%".$cari."%' order by no asc ");
		} else {$sql = mysqli_query($kon,"select * from pembelian_lokal order by no asc");
			}
        ...
        <td style="text-align: center;"><?php echo $saa['no']; ?></td>
				...
				<td style="text-align: center;"><?php echo (number_format($saa['jumlah'],0,',','.')); ?></td>
				<td style="text-align: center;"><?php echo $saa['satuan']; ?></td>
				<td><?php echo $saa['penyedia']; ?></td>

				<td style="text-align: center;">
							
					<a class="edit.record" href="#" data-target="#md2" data-toggle="modal" data-id=<?php echo $saa ['no_pl'] ; ?>>
            <i class="nav-icon fas fa-key text-info"></i>
          </a>&nbsp&nbsp
					
					<a href="pl_hapus.php?id=<?php echo $saa ['no_pl'];?>">
		...
		<tr>
			...
			<div class="modal fade" tabindex="-1" role="dialog" id="md2">
  				<div class="modal-dialog" role="document">
    				<div class="modal-content">
      					<div class="modal-header">
        					<h5 class="modal-title">Edit Data Pembelian Lokal</h5>
        					<button type="button" class="close" data-dismiss="modal" aria-label="Close">
          						<span aria-hidden="true">&times;</span>
        					</button>
      					</div>
