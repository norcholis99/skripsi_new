...
$pdf->SetFont('Arial','',10);
$pdf->SetX(0);
$pdf->MultiCell(95,10,'Laporan Data Piutang Periode Bulan '.$bln_list[date('m')].' '.date('Y'),0,'C');
...
if ($_GET['tanggal1']) {
    ...
    $tgl=$_GET['tanggal1'];
    $tgl2=$_GET['tanggal2'];
$piutang_2 = mysqli_query($kon, "select * from piutang where tanggal between '$tgl' and '$tgl2'");
while ($row = mysqli_fetch_array($piutang_2)){
